"""
Django settings for twilio_chatbot project.
...
SECRET_KEY = 't*&m23q4te15@1c&_p63wwl8(#0k701pg)^2$83tx%-g99vpcu'
...
ROOT_URLCONF = 'twilio_chatbot.urls'
...
WSGI_APPLICATION = 'twilio_chatbot.wsgi.application'
